        ...
        @if (auth()->user()->isAdmin())
            <flux:sidebar.nav> <!-- BARRA SUPERIOR CON LOS BASICOS DEL ADMINISTRADOR-->
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:sidebar.item icon="printer" :href="route('admin.reports')"
                        :current="request()->routeIs('admin.reports')" wire:navigate>
                        {{ __('Reportes') }}
                    </flux:sidebar.item>
                    <flux:sidebar.item icon="chart-bar" :href="route('admin.processes')"
                        :current="request()->routeIs('admin.processes')" wire:navigate>
                        {{ __('Procesos') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
            ...
            <flux:sidebar.nav> <!-- BARRA SUPERIOR CON LOS BASICOS DEL USUARIO-->
                <flux:sidebar.group :heading="__('Gestion')" class="grid">
                    ...
                    <flux:sidebar.item icon="chart-pie" :href="route('user.cases-tracking')"
                        :current="request()->routeIs('user.cases-tracking')" wire:navigate>
                        {{ __('Tracking') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
